	...
	function (
		...
		return function Help(container) 
		{
				...
				var width   = $("body").width(),
					...
					steps   = [
						btnAdd.length ? {
							...
							width: btnAdd.outerWidth(),
							height: btnAdd.outerHeight()
						} : { },
						{
						...
						btnOrga.length ? {
							...
							width: btnOrga.outerWidth(),
							height: btnOrga.outerHeight()
						} : { },
						null,
						{
			...
			function updateContent()
			{
				var content = [
					"<span>" 
						+ i18n.builder.help.content1Div1.replace(/%TPL_NAME%/g, app.cfg.TPL_NAME)
						+ "<br /><br />"
						+ i18n.builder.help.content1Div2
					+ "</span>",
					"<span>"
					...
					+ "</span>",
					"<span>"
						+ "<img class='floatright' src='resources/tpl/builder/icons/builder-help-topic3.png' style='margin-top: 15px'/><br />"
						+ i18n.builder.help.content3Div1.replace(/%TPL_NAME%/g, app.cfg.TPL_NAME)
						+ "<br /><br />"
						+ i18n.builder.help.content3Div2.replace(/%TPL_NAME%/g, app.cfg.TPL_NAME)
					+ "</span>",
					"<span>"
					...
					+ "<span>",
					"<span>"
						+ "<img class='floatright' style='margin-top:18px' src='resources/tpl/builder/icons/builder-help-topic5.png' /><br />"
						+ i18n.builder.help.content5Div1.replace(/%TPL_NAME%/g, app.cfg.TPL_NAME)
						+ "<br /><br />"
						+ i18n.builder.help.content5Div2.replace(/%TPL_NAME%/g, app.cfg.TPL_NAME)
					+ "</span>",
					"<span>"
						+ i18n.builder.help.content6AltDiv1
						+ "<table style='width: 100%; text-align: center; margin: 10px 0;'>"
						+ " <tr>"
						+ "  <td><strong>" + i18n.builder.help.content6AltDiv2 + "</strong></td>" 
						+ "  <td><strong>" + i18n.builder.help.content6AltDiv3 + "</strong></td>" 
						+ " </tr>"
						+ " <tr>"
						+ "  <td><img class='tips-sync-on'  src='resources/tpl/builder/icons/builder-help-topic6-sync-placeholder.png' /></td>"
						+ "  <td><img class='tips-sync-off' src='resources/tpl/builder/icons/builder-help-topic6-sync-placeholder.png' /></td>"
						+ " </tr>"
						+ "</table>"
						+  i18n.builder.help.content6AltDiv4
						+ '</div>'
					+ "</span>"
					/*
					"<span>"
						...
						+ "<br /><br />"
						+   i18n.builder.help.content6Div2
						+ "<br /><br />"
						+   i18n.builder.help.content6Div3
						+ '</div>'
					+ "</span>"
					*/
				];
				...
				container.find('.tips-sync-on').hover(
					function(){
						$(this).attr('src', 'resources/tpl/builder/icons/builder-help-topic6-sync-on.gif');
					}, 
					function(){
						$(this).attr('src', 'resources/tpl/builder/icons/builder-help-topic6-sync-placeholder.png');
					}
				);
				
				container.find('.tips-sync-off').hover(
					function(){
						$(this).attr('src', 'resources/tpl/builder/icons/builder-help-topic6-sync-off.gif');
					}, 
					function(){
						$(this).attr('src', 'resources/tpl/builder/icons/builder-help-topic6-sync-placeholder.png');
					}
