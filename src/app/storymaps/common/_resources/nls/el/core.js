define({
  "commonCore": {
    ...
    "inlineFieldEdit": {
      ...
      "enterSubtitle": "Εισαγωγή προαιρετικού υπότιτλου..."
    },
    "builderPanel": {
    ...
    "saveErrorSocial": {
      ...
      "panel1": "Η εμφάνιση της αφήγησής σας στα μέσα κοινωνικής δικτύωσης βελτιώθηκε, αλλά ο τίτλος αντικειμένου της διαδικτυακής εφαρμογής ArcGIS δεν είναι ίδιος με τον τίτλο της αφήγησης.",
    ...
    "extendedSupportMessage": {
      "bannerMsg": "Οι Classic Esri Story Maps βρίσκονται στην Extended Support",
      "s1h1": "Σημαντικό μήνυμα για classic Esri Story Maps",
      "s1p1": "Τα πρότυπα Classic Esri Story Maps βρίσκονται στην Extended Support. Όλοι οι πελάτες ενθαρρύνονται να χρησιμοποιούν το ArcGIS StoryMaps, το σύγχρονο εργαλείο αφήγησης της Esri.",
      "s1p2": "Τα κλασικά πρότυπα δεν βρίσκονται πλέον σε ενεργό ανάπτυξη και δεν συνιστώνται για νέα έργα. Δεν προγραμματίζονται περαιτέρω ενημερώσεις για τις δυνατότητές τους. Οι ιστορίες που έχετε δημιουργήσει χρησιμοποιώντας τα κλασικά πρότυπα θα συνεχίσουν να είναι διαθέσιμες.",
      "s1p3": "Τον Δεκέμβριο του 2021, τα κλασικά πρότυπα θα αφαιρεθούν από την προεπιλεγμένη γκαλερί εφαρμογών με δυνατότητα ρύθμισης παραμέτρων. Ένα ή περισσότερα κλασικά πρότυπα ενδέχεται να προστεθούν στην προσαρμοσμένη ομάδα εφαρμογών του οργανισμού σας, εάν απαιτείται για την υποστήριξη των τρεχουσών ροών εργασίας κατά τη μετάβασή σας στη χρήση ArcGIS StoryMaps.",
      "s1p4": "Για περισσότερες πληροφορίες, κάντε κλικ στον παρακάτω σύνδεσμο μάθετε περισσότερα.",
      "action1": "Κλείσιμο",
      "action2": "Περισσότερες πληροφορίες",
      "action3": "Δοκιμάστε το ArcGIS StoryMaps"
    },
    "matureSupportMessage": {
      "bannerMsg": "Τα Classic Esri Story Maps υπάρχουν στην Mature Support",
      "s1h1": "Σημαντικό μήνυμα για classic Esri Story Maps",
      "s1p1": "Τα πρότυπα Classic Esri Story Maps βρίσκονται στην Mature Support. Όλοι οι πελάτες ενθαρρύνονται να χρησιμοποιούν το ArcGIS StoryMaps, το σύγχρονο εργαλείο αφήγησης της Esri.",
      "s1p2": "Τα κλασικά πρότυπα δεν βρίσκονται πλέον σε ενεργό ανάπτυξη και δεν συνιστώνται για νέα έργα. Δεν προγραμματίζονται περαιτέρω ενημερώσεις για τις δυνατότητές τους. Οι ιστορίες που έχετε δημιουργήσει χρησιμοποιώντας τα κλασικά πρότυπα θα συνεχίσουν να είναι διαθέσιμες.",
      "s1p3": "Για περισσότερες πληροφορίες, κάντε κλικ στον παρακάτω σύνδεσμο μάθετε περισσότερα.",
      "action1": "Κλείσιμο",
      "action2": "Περισσότερες πληροφορίες",
      "action3": "Δοκιμάστε το ArcGIS StoryMaps"
    },
    "sectionNavigation": {
      "select": "Επιλογή καταχώρισης...",
      "section": "Καταχώριση",
      "thisSection": "Αυτή η καταχώριση",
      "hiddenSection": "Κρυφή καταχώριση"
    },
    "embedBar": {
      "share": "Κοινοποίηση",
