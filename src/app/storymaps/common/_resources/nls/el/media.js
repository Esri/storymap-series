define({
  "commonMedia": {
    ...
    "mediaConfigure": {
      ...
      "useParentOriginLabel": "Να επιτρέπεται στα μέλη άλλων οργανισμών να αποκτούν πρόσβαση στο περιεχόμενο αυτό.",
      "useParentOriginTooltip": "Ενεργοποιήστε την επιλογή μόνο αν η ιστοσελίδα είναι web εφαρμογή του ArcGIS η οποία έχει κοινοποιηθεί σε μέλη άλλων οργανισμών. Στον οργανισμό σας πρέπει να είναι ενεργοποιημένη η επιλογή σύνδεσης σε άλλους οργανισμούς.",
      ...
      "tooltipAltText": "Καταχωρίστε μια περιγραφή του περιεχομένου αυτού του πολυμέσου η οποία θα χρησιμοποιηθεί από βοηθητικές τεχνολογίες, π.χ. από το λογισμικό της συσκευής ανάγνωσης της οθόνης. Η περιγραφή είναι προαιρετική, αλλά συνιστούμε να τηρήσετε τις κατευθυντήριες οδηγίες για την προσβασιμότητα του web, π.χ. την οδηγία WCAG και την Ενότητα 508."
    },
    "editorActionGeocode": {
    ...
    "editorActions": {
      "navigate": "Πλοήγηση σε κάποια άλλη καταχώριση",
