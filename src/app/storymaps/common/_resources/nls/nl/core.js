	 ...
	 ({
		commonCore: {
			...
			builderPanel: {
				...
				shareStatus1: "De applicatie is nog niet opgeslagen",
			...
			saveError: {
				...
				btnOk: "De applicatietitel bewerken"
			},
			share: {
				...
				firstSaveA1bis: "De applicatie is ook te vinden in uw <a href='%LINK2%' target='_blank'>%PORTAL%-contentfolder</a>.",
				...
				shareQ0: "Hoe kan ik een applicatie inbedden in een webpagina?",
				...
				shareQ2bis: "Hoe keer ik terug naar de builderinterface?",
