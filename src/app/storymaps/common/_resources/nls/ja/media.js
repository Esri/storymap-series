define({
  "commonMedia": {
    ...
    "imageSelectorUpload": {
      ...
      "warningOneFile": "一度に 1 つのファイルを受け付けます。",
    ...
    "mediaConfigure": {
      ...
      "lblPosition4": "ストレッチ",
      "lblPosition5": "カスタム",
      "lblURLHelp": "画像は 400 KB 未満にすることを推奨します。80% の品質で圧縮された JPG 画像を使用します。推奨される画像の幅は、メイン ステージまたは最大化ボタン付きの注釈パネルの場合は 2000 ピクセル、最大化ボタンのない注釈パネルの場合は 1000 ピクセルです。<br><br>リンク付き画像の描画が遅い場合、画像をストーリーにアップロードすると早くなります。",
