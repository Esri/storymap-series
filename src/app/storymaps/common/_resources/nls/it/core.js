define({
  "commonCore": {
    ...
    "inlineFieldEdit": {
      ...
      "enterTitle": "Immetti titolo...",
      "enterSubtitle": "Immetti sottotitolo facoltativo..."
    },
    "builderPanel": {
    ...
    "saveErrorSocial": {
      ...
      "panel1": "L'aspetto della storia sui social media è stato migliorato, ma il titolo dell'elemento dell'applicazione web ArcGIS non è lo stesso del titolo della storia.",
    ...
    "settingsHeader": {
      ...
      "logoCustomUploadHelp": "L’immagine del logo deve iniziare con HTTPS. I loghi vengono visualizzati in modo ottimale se il relativo rapporto larghezza/altezza è compreso tra 1:1 e 5:1. Se la visualizzazione di un logo collegato è lenta, salvare una copia e caricarla qui.",
      ...
      "logoCustomLinkHTTPSError": "Il link deve iniziare con HTTPS",
    ...
    "sectionNavigation": {
      ...
      "section": "Voce",
      "thisSection": "Questa voce",
      "hiddenSection": "Voce nascosta"
    },
    "embedBar": {
      "share": "Crea",
