define({
  "commonWebmap": {
    "selector": {
      ...
      "tooltipGeocoder": "Cho phép người xem của bạn tìm kiếm các địa chỉ, địa điểm và/hoặc các đối tượng trên bản đồ của bạn. Các tùy chọn tìm kiếm có thể được cấu hình trên một trang mục của bản đồ web trong phần Thiết lập > Bản đồ Web > Ứng dụng > Tìm các Vị trí.",
      "lblEsriGeocoder": "Trình tìm kiếm Địa chỉ trên Toàn cầu",
