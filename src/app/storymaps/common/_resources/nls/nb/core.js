	 ...
	 ({
		commonCore: {
			...
			builderPanel: {
				...
				shareStatus1: "Programmet er ikke lagret ennå",
			...
			share: {
				...
				firstSaveA1bis: "Du finner også programmet i <a href='%LINK2%' target='_blank'>innholdsmappen din i %PORTAL%</a>.",
				...
				shareQ2bis: "Hvordan kommer jeg tilbake til grensesnittet for byggeverktøyet?",
