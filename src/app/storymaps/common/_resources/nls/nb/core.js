define({
  "commonCore": {
    ...
    "inlineFieldEdit": {
      ...
      "enterSubtitle": "Angi valgfri undertittel..."
    },
    "builderPanel": {
    ...
    "extendedSupportMessage": {
      ...
      "s1p2": "Classic-malene blir ikke videreutviklet og anbefales ikke til nye prosjekter. Det er ingen planer om å oppdatere funksjonaliteten i disse malene. Historier som er opprettet ved hjelp av Classic-malene, vil fortsatt være tilgjengelige.",
    ...
    "sectionNavigation": {
      "select": "Velg en oppføring...",
      "section": "Oppføring",
      "thisSection": "Denne oppføringen",
      "hiddenSection": "Skjult oppføring"
    },
    "embedBar": {
      "share": "Del",
