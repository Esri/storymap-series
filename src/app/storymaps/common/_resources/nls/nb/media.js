define({
  "commonMedia": {
    ...
    "mediaConfigure": {
      ...
      "tooltipAltText": "Angi en beskrivelse av dette medieinnholdet som brukes av hjelpeteknologi som skjermleserprogramvare. Beskrivelsen er valgfri, men anbefales for å oppfylle retningslinjene for universell utforming av nettinnhold, som WCAG og Section 508."
    },
    "editorActionGeocode": {
    ...
    "editorActions": {
      "navigate": "Naviger til en annen oppføring",
