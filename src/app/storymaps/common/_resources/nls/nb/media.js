define(
	 ({
		commonMedia: {
			...
			videoSelectorOther: {
				explain1: "Programmet kan ikke spille av råvideoer (f.eks. AVI- eller MPEG-filer), men det kan spille av hostede videofiler som har innebygde spillere (f.eks. YouTube eller Vimeo).",
