define({
  "commonWebmap": {
    "selector": {
      ...
      "lblLegend": "Legenda",
      "lblGeocoder": "Localizador de Endereço, Local e Feição",
      "tooltipGeocoder": "Permite que seus leitores pesquisem endereços, locais e/ou feições em seu mapa. As opções de pesquisa podem ser configuradas em uma página do item do mapa da web em Configurações > Mapa da Web > Aplicativo > Encontrar Local.",
