	 ...
	 ({
		commonCore: {
			...
			share: {
				...
				firstSaveA1bis: "O aplicativo também pode ser encontrado na sua <a href='%LINK2%' target='_blank'>pasta  de conteúdo do %PORTAL%</a>.",
				...
				shareQ2bis: "Como volto para a interface do construtor?",
