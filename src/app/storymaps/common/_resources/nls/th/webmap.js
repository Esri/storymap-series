	 ...
	 ({
		commonWebmap: {
			selector: {
				...
				originalWebmap: "เว็บแมพใช้เพื่อเผยแพร่ the %TPL_NAME%",
				browseMaps: "ค้นหาแผนที่",
				current: "เว็ปแมพปัจจุบัน",
				select: "ค้นหาเว็บแมพ",
				...
				tooltipPopup: "เลือกป๊อปอัพที่จะถูกเปิดเมื่อแสดงแผนที่",
		...
		configure: {
			mapdlg:{
				...
				ok: "ตกลง",
				cancel: "ยกเลิก",
				placeholder: "เพิ่มคำค้นหาหรือไอดีเว็บแมพ"
			}
		}
	})
);
