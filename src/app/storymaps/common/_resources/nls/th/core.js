	 ...
	 ({
		commonCore: {
			common: {
				...
				start: "เริ่ม",
				loading: "กำลังโหลด",
				disabledAdmin: "ฟีเจอร์นี้ได้รับการแสดงโดยผู้ดูแลระบบ",
				width: "ความกว้าง",
				height: "ความสูง"
			},
			inlineFieldEdit: {
			...
			builderPanel: {
				...
				saveError: "การบันทึกล้มเหลม กรุณาลองอีกครั้ง",
			...
			share: {
				...
				sharePrivateWarning: "แบ่งปัน %WITH% ไม่สามารถใช้งานได้ เนื่องจากคุณไม่ใช่เจ้าของ <a href='%LINK%' target='_blank'>webmap</a>",
