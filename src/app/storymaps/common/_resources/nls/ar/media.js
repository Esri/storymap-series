define({
  "commonMedia": {
    ...
    "videoSelectorOther": {
      "explain1": "يتعذر على القصة تشغيل مقاطع الفيديو البسيطة (بامتدادات مثل avi وmpeg)، ولكن يمكنها تشغيل ملفات الفيديو المستضافة ذات المشغلات المدمجة (مثل YouTube أو Vimeo).",
