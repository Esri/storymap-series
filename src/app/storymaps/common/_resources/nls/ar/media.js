define({
  "commonMedia": {
    ...
    "mediaConfigure": {
      ...
      "useParentOriginLabel": "اسمح لأفراد من مؤسسات أخرى بالوصول إلى هذا المحتوى.",
      "useParentOriginTooltip": "قم بتمكين هذا الخيار فقط إذا كانت صفحة الويب هي تطبيق ويب ArcGIS الذي تمت مشاركته مع أفراد المؤسسات الأخرى. يجب أن يتوفر لمؤسستك الخيار لتسجيل الدخول إلى مءسسات أخرى تم تمكينها.",
      "learn": "تعلم المزيد",
      "lblAltText": "نص بديل",
      "placeholderAltText": "أدخل وصفًا لهذه الوسائط الخاصة بقرّاء ضاف البصر...",
      "tooltipAltText": "قم بتوفير وصف لمحتوى الوسائط الذي سيتم استخدامه بواسطة التقنيات الداعمة، مثل برنامج قراءة الشاشة. يعد الوصف اختياريًا، ولكن يُوصى به لتلبية إرشادات قابلية الوصول، مثل WCAG والقسم 508."
    },
    "editorActionGeocode": {
