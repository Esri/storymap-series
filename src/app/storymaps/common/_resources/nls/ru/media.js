define({
  "commonMedia": {
    ...
    "imageSelectorUpload": {
      ...
      "warningOneFile": "Одновременно может быть загруженно только одно изображение.",
    ...
    "mediaConfigure": {
      ...
      "useParentOriginLabel": "Разрешить участникам других организаций доступ к этому ресурсу.",
      "useParentOriginTooltip": "Включить эту опцию только в случае, если веб-страница является веб-приложением ArcGIS, которое доступно участникам других организаций. У вашей организации должна быть включена возможность входа в другие организации.",
      ...
      "tooltipAltText": "Предоставьте описание для этого медиа-ресурса, которое будет использоваться вспомогательными технологиями, такими как программное обеспечение для чтения с экрана. Описание является дополнительным, но рекомендуется в соответствии с инструкциями по веб-доступу, такими как WCAG и Section 508."
    },
    "editorActionGeocode": {
    ...
    "editorActions": {
      "navigate": "Перейти к другой записи",
