define({
  "commonWebmap": {
    "selector": {
      ...
      "lblLegend": "Legenda",
      "lblGeocoder": "Iskalnik po naslovu, kraju ali geoobjektih",
      ...
      "originalWebmap": "Karta je uporabljena za izdajo %TPL_NAME%",
    ...
    "configure": {
      ...
      "extentExplain": "Pomikajte se po karti in jo povečajte, da določite, kako bo videti za vaše bralce.",
    ...
    "editor": {
      ...
      "notavailable3": "Oprostite, ustvarjanje ali urejanje karte ni podprto v tej različici Portal for ArcGIS (potrebna je različica 10.4 ali novejša). Za več informacij se obrnite na vašega administratorja ArcGIS.",
