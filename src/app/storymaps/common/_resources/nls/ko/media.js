	 ...
	 ({
		commonMedia: {
			...
			mediaConfigure: {
				...
				unloadHelp: "웹 페이지에 오디오 또는 비디오 미디어가 있는 경우 이 옵션을 선택 상태로 유지하여 독자가 다른 위치를 탐색할 때 콘텐츠가 재생되는 것을 방지할 수 있습니다. 독자가 스토리를 진행할 때 사운드 트랙이 재생되도록 하려면 옵션을 선택 해제합니다.<br />웹 페이지가 응용프로그램인 경우 독자가 돌아왔을 때 응용프로그램이 다시 로드되지 않도록 이 옵션을 선택 해제합니다."
			},
			editorActionGeocode: {
