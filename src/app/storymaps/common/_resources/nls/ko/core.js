define({
  "commonCore": {
    ...
    "httpsTransitionMessage": {
      ...
      "s1p2": "이는 스토리맵의 모든 콘텐츠에 HTTP가 아닌 HTTPS로 시작하는 링크를 사용하여 접근해야 함을 의미합니다. HTTPS를 사용하면 대부분의 웹 브라우저에서 내 스토리가 안전한 것으로 나타나므로 독자에게 최상의 환경이 제공됩니다.",
      "s2h1": "해야 할 일",
