define({
  "commonWebmap": {
    "selector": {
      ...
      "tooltipGeocoder": "독자가 맵에서 주소, 장소 및/또는 피처를 검색할 수 있습니다. 검색 옵션은 웹 맵 항목 페이지의 설정(Setting) > 웹 맵(Web Map) > 응용프로그램(Application) > 위치 찾기(Find Locations)에서 구성할 수 있습니다.",
      ...
      "tooltipOverview": "기본 맵과 함께 소형 오버뷰 보기 맵을 표시합니다.",
      "tooltipLegend": "레이어 및 심볼이 맵에 많이 포함되어 있는 경우에 유용한 맵 범례를 맵에 표시합니다.",
      "mapCfgInvite": "이 컨트롤을 사용하여 맵 구성",
      "lblLocationAlt": "첫 번째 맵으로부터 상속됨",
      "tooltipLocationAlt": "이 맵의 위치는 맵 시리즈의 첫 번째 맵과 동기화됩니다. 시리즈에 대한 이 동작을 변경하려면 설정(Settings) > 맵 옵션(Map Options)으로 이동합니다."
    },
    "configure": {
      "btnReset": "재설정",
      "btnCancel": "취소",
    ...
    "editor": {
      ...
      "notavailable2": "죄송합니다. 스토리맵 응용프로그램이 %PRODUCT%에서 호스팅되지 않으므로 맵을 생성하거나 편집할 수 없습니다. 자세한 내용은 ArcGIS 관리자에게 문의하세요.",
