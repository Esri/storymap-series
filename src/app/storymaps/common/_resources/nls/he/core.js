define({
  "commonCore": {
    ...
    "httpsTransitionMessage": {
      ...
      "s2h1": "מה עלי לעשות?",
      "s2p1": "Esri פועלת כדי להקל על המחברים והקוראים של מפות סיפור לבצע את המעבר. בכלי העריכה של 'מפת סיפור' וב'הסיפורים שלי', העמדנו לרשותך כלים שיסייעו לך לזהות תוכן לא מאובטח (HTTP) בסיפורים שלך ויספקו המלצות לטיפול במצב. עליך לבדוק את הסיפורים שלך לאיתור תוכן לא מאובטח ועדכן ל-HTTPS לפני יוני 2018.",
      "action1": "סגור",
