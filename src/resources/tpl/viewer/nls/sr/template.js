define({
  "viewer": {
    ...
    "a11y": {
      ...
      "mainStageAria": "Aktuelni ulazni mediji priče",
      "logoLinkAria": "Link logotipa",
      "toTop": "Idi na prvi unos",
      "focusContent": "Vrati se na sadržaj",
      "navAria": "Unosi priče",
      "toEntryAria": "Idi na unos %ENTRY_NUMBER%: %ENTRY_TITLE%",
      "entryAria": "Unos %ENTRY_NUMBER%: %ENTRY_TITLE%",
      "loadingAria": "Sadržaj priče se učitava",
      "skipBelowContent": "Preskoči ispod ovog sadržaja",
      "skipBelowVideo": "Preskoči ispod ovog video zapisa",
      "skipAboveContent": "Preskoči iznad ovog sadržaja",
      "skipAboveVideo": "Preskoči iznad ovog video zapisa",
      "moreEntries": "Više unosa"
    },
    "loading": {
      "long": "Priča se pokreće",
      "long2": "Hvala na čekanju",
      "failButton": "Ponovno učitajte priču"
    },
    "signin": {
      "title": "Potvrda identiteta je obavezna",
      "explainViewer": "Prijavite se na nalog na %PORTAL_LINK% da biste pristupili priči.",
      "explainBuilder": "Prijavite se na nalog na %PORTAL_LINK% da biste konfigurisali priču."
    },
    "errors": {
      "boxTitle": "Došlo je do greške",
      "invalidConfig": "Nevažeća konfiguracija",
      "invalidConfigNoApp": "Identifikator Web Mapping aplikacije nije naveden u index.html.",
      "invalidConfigNoAppDev": "Identifikator Web Mapping aplikacije je određen u parametrima URL adrese (?appid=). U razvojnom režimu konfiguracija identifikacije aplikacije u index.html je zanemarena.",
      ...
      "invalidApp": "%TPL_NAME% ne postoji ili je nedostupan.",
    ...
    "mobileInfo": {
      "legend": "Legenda",
      "description": "Opis",
      "lblLegendMobileError": "Žao nam je, legenda nije dostupna. Ponovo učitajte priču.",
      "lblLegendMobileErrorExplain": "Legenda nije dostupna kada je uređaj rotiran u uspravan položaj nakon učitavanja priče."
    },
    "mobileFooter": {
      "swipeInvite": "Brzo prevucite da se krećete kroz priču",
      "lblNext": "Sledeće",
      "lblEnd": "Stigli ste do kraja priče"
    },
    "headerFromCommon": {
      ...
      "share": "Podeli",
      "checking": "Proveravanje sadržaja priče",
      "fix": "Popravite sporne stavke u priči",
      "noerrors": "Nema detektovanih spornih stavki",
      "tooltipAutoplayDisabled": "Ovo nije dostupno u režimu automatske reprodukcije",
      "notshared": "Priča nije podeljena"
    },
    "mapFromCommon": {
      "overview": "Pregledna mapa",
      "legend": "Legenda",
      "home": "Zumiraj matičnu stranicu"
    },
    "shareFromCommon": {
      "copy": "Kopiraj",
      "copied": "Kopirano",
