	 ...
	 ({
		viewer: {
			...
			mobileInfo: {
				...
				lblLegendMobileError: "Üzgünüz, gösterim kullanılamıyor. Uygulamayı yeniden yükleyin.",
				lblLegendMobileErrorExplain: "Uygulama yüklendikten sonra cihaz dikey moda döndürülürse gösterim kullanılamaz."
			},
			mobileFooter: {
