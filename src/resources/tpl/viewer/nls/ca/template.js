define({
  "viewer": {
    ...
    "a11y": {
      ...
      "panelAria": "Contingut de la història",
      "mainStageAria": "Contingut multimèdia de l'entrada de la història actual",
      "logoLinkAria": "Enllaç del logotip",
      "toTop": "Ves a la primera entrada",
      "focusContent": "Torna a l'inici",
      "navAria": "Entrades d'històries",
      "toEntryAria": "Ves a l'entrada %ENTRY_NUMBER%: %ENTRY_TITLE%",
      "entryAria": "Entrada %ENTRY_NUMBER%: %ENTRY_TITLE%",
      "loadingAria": "S'està carregant el contingut de la història",
      "skipBelowContent": "Ves a sota del contingut",
      "skipBelowVideo": "Ves a sota del vídeo",
      "skipAboveContent": "Ves a sobre del contingut",
      "skipAboveVideo": "Ves a sobre del vídeo",
      "moreEntries": "Més entrades"
    },
    "loading": {
      "long": "La història s'està inicialitzant",
    ...
    "errors": {
      ...
      "noBuilderIE": "El generador no és compatible amb les versions de l'Internet Explorer anteriors a la versió %VERSION%. %UPGRADE%",
    ...
    "panel": {
      "collapse": "Redueix la subfinestra",
      "expand": "Expandeix la subfinestra"
    },
    "mobileInfo": {
      "legend": "Llegenda",
      "description": "Descripció",
      "lblLegendMobileError": "La llegenda no està disponible. Torneu a carregar la història.",
      "lblLegendMobileErrorExplain": "La llegenda no està disponible quan el dispositiu es gira en posició vertical després de carregar la història."
    },
    "mobileFooter": {
      "swipeInvite": "Swipe per navegar per la història",
      "lblNext": "Següent",
      "lblEnd": "Heu arribat al final de la història"
    },
    "headerFromCommon": {
