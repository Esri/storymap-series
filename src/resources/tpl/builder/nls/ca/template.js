define({
  "builder": {
    ...
    "help": {
      ...
      "content4Div1": "Heu trobat una errada o voleu canviar el vostre material? Cap problema. Cerqueu la icona d'edició a l'aplicació per canviar el contingut. Fareu servir moltes vegades les funcions d'edició mentre desenvolupeu el vostre %TPL_NAME%.",
    ...
    "landing": {
      ...
      "quote4": "La gent no vol més informació. Està saturada d'informació. Volen creure... creure en vosaltres, en els vostres objectius, el vostre èxit i la història que expliqueu.",
