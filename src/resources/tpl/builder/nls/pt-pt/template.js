define({
  "builder": {
    ...
    "help": {
      ...
      "content4Div1": "Encontrou um erro ou pretende alterar o seu material? Não se preocupe. Procure o ícone de edição na aplicação para fazer alterações ao seu conteúdo. Irá utilizar as funções de edição diversas vezes enquanto desenvolve o seu %TPL_NAME%!",
    ...
    "landing": {
      ...
      "quote4": "As pessoas não querem mais informações. Já estão fartas de tanta informação. Querem confiar em si, nos seus objetivos, no seu sucesso, na história que conta.",
