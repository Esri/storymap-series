define({
  "builder": {
    ...
    "help": {
      ...
      "content4Div1": "Tìm thấy một lỗi sai hoặc muốn thay đổi tài liệu? Đừng lo lắng. Tìm biểu tượng chỉnh sửa trên ứng dụng để thay đổi nội dung. Bạn sẽ cần sử dụng các chức năng chỉnh sửa nhiều lần trong quá trình phát triển %TPL_NAME%!",
    ...
    "landing": {
      ...
      "quote4": "Mọi người không cần thêm thông tin. Họ đã chán ngấy thông tin rồi. Họ muốn tin tưởng vào bạn, mục tiêu, thành công của bạn và tin vào câu chuyện bạn kể.",
      ...
      "quote8": "Nếu không biết về cây cối, có thể bạn sẽ lạc trong rừng, nhưng nếu không biết những câu chuyện, có thể bạn sẽ lạc lối trong cuộc đời.",
      "quote9": "Những câu chuyện bản thân nó là sự chuyển đổi sáng tạo của cuộc sống thành trải nghiệm mạnh mẽ hơn, rõ ràng hơn và ý nghĩa hơn. Chúng chính là sự truyền bá của tiếp xúc giữa con người.",
      ...
      "quote12": "Câu chuyện là thứ vũ khí quyền lực nhất trong kho vũ khí của một người lãnh đạo.",
