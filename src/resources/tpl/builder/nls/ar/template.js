define({
  "builder": {
    ...
    "help": {
      ...
      "content4Div1": "هل تم العثور على خطأ أم تريد تغيير المادة؟ لا داعي للقلق. ابحث عن أيقونة التحرير في التطبيق لإجراء تغييرات على المحتوى. ستستخدم وظائف التحرير عدة مرات أثناء تطوير %TPL_NAME%!",
    ...
    "landing": {
      ...
      "quote4": "لا يريد الأشخاص المزيد من المعلومات. فما أكثرها. إنهم يريدون الإيمان بك وبأهدافك ونجاحك في القصة التي ترويها.",
      "quote5": "أومن بشدة بأن الناس يبحثون عن قصص تدل حقًا على شيء ما، قصص إنقاذ وقصص ملهمة وقصص تتخطى مجرد الحديث عن شخص.",
      ...
      "quote8": "إذا لم تكن على علم بالأشجار، فقد تضل طريقك في الغابة، أما إذا لم تكن على علم بالقصص، فقد تضل طريقك في الحياة.",
      ...
      "quote12": "فالقصص هي أقوى سلاح فردي في ترسانة أسلحة القائد.",
