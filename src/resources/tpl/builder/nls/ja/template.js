define({
  "builder": {
    ...
    "help": {
      ...
      "content4Div1": "誤りを見つけてしまった場合、データを変更したいですよね？ 心配は要りません。 アプリ内の編集アイコンを使用して、コンテンツを変更できます。 %TPL_NAME% の開発では、好きなだけ編集機能を使用できます。",
    ...
    "landing": {
      ...
      "lblOR": "または",
      "lblHelp": "ツアーの開始",
      "quote0": "ユーザーを別の世界へ連れて行くことができるストーリーを作ることができます。",
      "quote1": "ストーリーテリングは、アイデアを世界に公開する、現在最も強力な方法です。",
      "quote2": "伝えられるストーリーは、文字通り世界を作ります。世界を変えたい場合は、ストーリーを変える必要があります。このことは、個人にも団体にも該当します。",
      "quote3": "人間と現実との距離を最短に縮めるのはストーリーです。",
      "quote4": "ユーザーが求めているのは情報の量ではありません。 ユーザーには多くの情報があふれています。 ユーザーが求めているのは、あなた自身、あなたの目標と成功、あなたが語るストーリーの信頼性です。",
      "quote5": "有益で、魅力的で、個人規模より大きなストーリーをユーザーは求めています。",
      "quote6": "個人またはグループにその日常生活において特別な価値を与えたい場合は、説得力のあるストーリーを伝えてください。",
      "quote7": "話すものはエッセイであり、 見せるものはストーリーです。",
      "quote8": "木を知らなければ、森の中で迷ってしまいますが、ストーリーがわからなければ、人生で迷ってしまいます。",
      "quote9": "ストーリーは、人生そのものをより強力でより明確で、さらに意味のあるものに創造的に変えたものです。ストーリーは、人とのつながりの手段です。",
      "quote10": "あなたの中にあるストーリーを伝えずにおく以上の苦しみはありません。",
      "quote11": "きっと、ストーリーは、その人の魂がこもったものです。",
      "quote12": "ストーリーは、リーダーの武器として、1 つの最も強力な武器となります。",
      "quote13": "ストーリーに含まれるものよりはるかに多くを残すのがストーリーの持つ本質です。"
    }
  }
});