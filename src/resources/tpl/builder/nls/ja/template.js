define({
  "builder": {
    ...
    "settingsMapOptions": {
      ...
      "lblLocate": "ボタンの検索",
      "tooltipLocate": "マップ上に閲覧者の現在地を示すボタンを表示します。この機能は、ほとんどのデバイスおよびブラウザーでサポートされていますが、このボタンは、ストーリーを HTTPS リンクとして共有し、そのストーリーが埋め込まれていない場合にのみ表示されます。",
      "lblGeocoder": "住所または場所のファインダ",
      "tooltipGeocoder": "閲覧者はマップ上の住所と場所を検索できます。",
      "lblSync": "マップ位置の同期",
