	 ...
	 ({
		builder: {
			...
			settingsMapOptions: {
				...
				tooltipLocate: "Esta funcionalidad se admite en la mayoría de los dispositivos móviles y navegadores de escritorio (Internet Explorer 9).",
			...
			organizePopup: {
				title: "Organizar",
				lblHeader: "Arrastra y suelta %LBL_LAYOUT% para organizar tu serie.",
				lblColTitle: "Título",
				lblColStatus: "Estado",
