define({
  "builder": {
    ...
    "help": {
      ...
      "content4Div1": "Sie haben einen Fehler gefunden oder möchten Änderungen vornehmen? Kein Problem. Halten Sie in der App nach dem Bearbeitungssymbol Ausschau, um Änderungen an den Inhalten vorzunehmen. Bei der Arbeit mit %TPL_NAME% werden Sie die Bearbeitungsfunktionen unzählige Male einsetzen.",
    ...
    "landing": {
      ...
      "quote4": "Menschen möchten nicht noch mehr Informationen. Sie werden regelrecht damit überhäuft. Sie möchten Ihnen Glauben schenken – an Sie, Ihre Ziele, Ihren Erfolg und Ihre Geschichte.",
      "quote5": "Ich bin der Meinung, dass Menschen auf der Suche nach bedeutungsvollen Geschichten sind – Geschichten, die motivieren, die inspirieren, die größer als der Einzelne sind.",
