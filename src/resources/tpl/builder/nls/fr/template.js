define({
  "builder": {
    ...
    "help": {
      ...
      "content4Div1": "Vous avez trouvé une erreur ou souhaitez modifier vos documents ? Aucun problème. Recherchez l’icône de mise à jour dans toute l’application pour apporter des modifications à votre contenu. Vous allez utiliser les fonctions de mise à jour de nombreuses fois au cours du développement de votre %TPL_NAME% !",
    ...
    "landing": {
      ...
      "quote5": "Je crois profondément que les gens recherchent des récits qui ont un sens réel, des récits rédempteurs, inspirants et qui vont au-delà d’un seul individu.",
      ...
      "quote8": "Si vous ne connaissez pas les arbres, vous risquez de perdre vos repères en forêt, mais si ne connaissez pas les récits, vous risquez de perdre vos repères dans la vie.",
