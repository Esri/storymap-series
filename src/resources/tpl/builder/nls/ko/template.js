define({
  "builder": {
    ...
    "settingsMapOptions": {
      ...
      "lblLocate": "버튼 위치",
      "tooltipLocate": "맵에 뷰어의 위치를 나타내는 버튼을 표시합니다. 이 기능은 대부분의 기기와 브라우저에서 지원되지만 스토리를 HTTPS 링크로 공유하고 스토리가 임베드되어 있지 않은 경우에만 버튼이 나타납니다.",
      "lblGeocoder": "주소 또는 장소 찾기",
      "tooltipGeocoder": "뷰어가 맵에서 주소와 장소를 찾을 수 있습니다.",
      "lblSync": "맵 위치 동기화",
