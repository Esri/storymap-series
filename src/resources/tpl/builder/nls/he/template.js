define({
  "builder": {
    ...
    "help": {
      ...
      "content4Div1": "מצאת שגיאה או מעוניין לשנות את החומר שלך? אין בעיה. חפש את סמל העריכה ברחבי האפליקציה כדי לבצע שינויים בתוכן שלך. אתה צפוי להשתמש בפונקציות העריכה פעמים רבות לאורך פיתח %TPL_NAME% שלך!",
